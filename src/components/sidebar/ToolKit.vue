...
import ChatVue from "../Chat/Main.vue";
import RecentVue from "../Recent/Main.vue";
...
export default {
  ...
  data() {
    return {
      ...
      selectedLabel: "",
      isVisible: false,
      IconComponent: markRaw(IconComponentVue),
    };
  },
  props: {
    toolkitStyle: Object,
